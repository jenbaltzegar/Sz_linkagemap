...
## I have found that changing the value for max.rf does little to change the data, therefore use default
twopts <- rf.2pts(batch_30.out, LOD = 13, max.rf = 0.5)
...
## Seriation does not work with too many markers
...
LG12.extend <- try.seq(LG12.frame, 60, draw.try = TRUE)
LG12.extend
print(LG12.extend,6)
